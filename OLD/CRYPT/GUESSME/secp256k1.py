...
# print(bytes_to_int(b'\x01\x02'))  # Kết quả: 258
...
# Extended Euclidean Algorithm - Tính nghịch đảo
# print(inv(3, 11))  # Kết quả: 4 (vì 3 * 4 % 11 = 1)
...
# p = (Gx, Gy)
# print(to_jacobian(p))  # Kết quả: (Gx, Gy, 1)
